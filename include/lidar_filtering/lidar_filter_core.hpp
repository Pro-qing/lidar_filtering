...
//     // 通用点云滤波器（降采样、高度、去噪、地面、半径）
//     // 内部使用了 static thread_local 进行内存优化
...
private:
    ...
    struct ChargeCache {
        ...
        std::mutex charge_cache_mutex_; // 保护缓存的互斥锁
